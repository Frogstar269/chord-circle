    ...
    this.on('keydown', function(e) {
      if(inShift == 0){
        if(inCtrl == 0){
          ...
          var keyData = KEYCODE_TO_KEYDATA_MAP_ctrl[e.keyCode];
        }
      }else{
        if(inCtrl == 0){
          var keyData = KEYCODE_TO_KEYDATA_MAP_shift[e.keyCode];
        }else{
          var keyData = KEYCODE_TO_KEYDATA_MAP_ctrl_shift[e.keyCode];
        }
      }
